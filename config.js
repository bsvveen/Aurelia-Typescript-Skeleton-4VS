System.config({
    ...
    // Not yet able to set scriptLoad: true as global setting, this gives an router error
    //packages: {
    //    "pages": {
    //        defaultExtension: "js",
    //        modules: {
    ...
    meta: {
        "main": { scriptLoad: true, format: "global" },
        "routerConfig": { scriptLoad: true, format: "global" },
        "baseConfig": { scriptLoad: true, format: "global" },
        "app": { scriptLoad: true, format: "global" },
        "httpConfiguration": { scriptLoad: true, format: "global" },
        "pages/welcome": { scriptLoad: true, format: "global" },
        "pages/users": { scriptLoad: true, format: "global" },
        "pages/flickr": { scriptLoad: true, format: "global" },
        "pages/child-router": { scriptLoad: true, format: "global" }
    },
